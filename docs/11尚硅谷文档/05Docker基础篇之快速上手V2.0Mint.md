...
环境配置如此麻烦，换一台机器，就要重来一次，费力费时。很多人想到，能不能从根本上解决问题，软件可以带环境安装也就是说，安装的时候，把原始环境一模一样地复制过来。开发人员利用Docker可以消除协作编码时“在我的机器上可正常工作”的问题。
...
![](image/ /Snipaste_2020-10-02_18-22-04.png)
...
![](image//Snipaste_2020-10-02_18-31-11.png)
...
仓库(**Repository**)和仓库注册服务器(**Registry**) 是有区别的。仓库注册服务器上往往存放着多个仓库，每个仓库中又包含了多镜像，每个镜像有不同的标签(tag) 。仓库分为公开仓库(**Public**) 和私有仓库(**Private**) 两种形式。
...
![](image//Snipaste_2020-10-02_19-50-17.png)
...
![](image//Snipaste_2020-10-02_20-19-10.png)
...
启动docker:  systemtcl start  docker 

#### 重启容器

systemtcl  restart docker  容器ID或容器签名

#### 停止容器

systemtcl docker stop 容器ID或容器签名
...
![](image//Snipaste_2020-10-03_15-36-01.png)
...
![](image//Snipaste_2020-10-03_15-37-05.png)
...
![](image//Snipaste_2020-10-03_15-41-51.png)
...
![](image//Snipaste_2020-10-03_15-43-31.png)

#### 删除doc02后doc3是否访问

![](image//Snipaste_2020-10-03_15-43-57.png)

在进一步

![](image//Snipaste_2020-10-03_15-44-11.png)

#### 新建doc04继承doc03 然后删除doc03

![](image//Snipaste_2020-10-03_15-44-56.png)
...
![](image//Snipaste_2020-10-03_17-32-12.png)
...
![](image//Snipaste_2020-10-03_17-35-08.png)
...
![](image//Snipaste_2020-10-03_17-47-58.png)

小总结

![](image//Snipaste_2020-10-03_17-48-16.png)
...
FROM centos 
#作者 是mint
MAINTAINER mint<2848029855@qq.com>
#登录 的初始路径 落脚点
WORKDIR $MYPATH
...
![](image//Snipaste_2020-10-03_18-58-14.png)
...
![](image//Snipaste_2020-10-03_19-00-48.png)
...
![](image//Snipaste_2020-10-04_12-28-49.png)

#### 测试持久化文件生成

![](image//Snipaste_2020-10-04_12-29-12.png)
...
![](image//Snipaste_2020-10-04_12-49-17.png)
...
![](image//Snipaste_2020-10-04_12-50-48.png)
...
![](image//Snipaste_2020-10-04_12-51-52.png)
...
![](image//Snipaste_2020-10-04_12-53-02.png)

#### 3、创建镜像仓库

![](image//Snipaste_2020-10-04_12-54-07.png)
...
![](image//Snipaste_2020-10-04_12-56-10.png)

#### 5、公有云可以查询得到

![](image//Snipaste_2020-10-04_12-56-53.png)

#### 6、查看详情

![](image//Snipaste_2020-10-04_12-57-23.png)



### 将阿里云上的镜像下载到本地

![](image//Snipaste_2020-10-04_12-59-00.png)
